...
export const createComment = async (req, res) => {
    try {
        ...
        let audioUrl;
        if (file && file.buffer) {
            audioUrl = await uploadToAzure(file.buffer, file.originalname, file.mimetype, 'comments');
        }
 ...
 *               $ref: '#/components/schemas/Error'
 */
export const getCommentsByVoicePin = async (req, res) => {
    try {
        const voicePinId = req.params.voicePinId;
